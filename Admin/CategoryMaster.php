...
<!-- Add/ update Modal -->
<div class="modal fade addUpdateModal" id="CategoryModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <form action="" class="AddForm" id="addcategory_form" novalidate>
                        <div class="px-4 py-5">
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" id="category_name" name="CategoryName" class="form-control" placeholder="Enter Category Name" required>
                                </div>
                            </div>
                        ...
                        <div class="px-4 py-5">
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" id="update_category_name" name="UpdateCategoryName" class="form-control" placeholder="Enter Category Name" required>
                                </div>
                            </div>
                            ...
                            <div class="mt-3 row">
                                ...
                                <div class="col-lg-9">
                                    <input type="file" id="update_category_image" name="UpdateCategoryImage" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-body">
                            <div class="row justify-content-between">
                                ...
                                <div class="col-lg-4 text-end col-4">
                                    <button class="btn add_master px-5" data-bs-toggle="modal" data-bs-target="#CategoryModal"> <span> <i class="material-icons">add</i> </span> <span>Add Category</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        ...
        var MasterTable = $('#MasterTable').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row, meta) {
                        if (type == 'display') {
                            data = ' <div>   <img class="categoryImage" src="../CATEGORY/' + data +'"> </div>'
                        }
                        return data;
                    }
                },
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#category_name') && $(el).val().match(/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/)) {
                    ...
                    success: function(data) {
                        ...
                        if (TestJson(data) == true) {
                            ...
                            if (response.addCategory == "0") {
                                ...
                                $('#ResponseText').text("Category is Already Present");
                                ...
                                $('#ResponseText').text("Successfully Added Category");
                                $('#confirmModal').modal('show');
                                ...
                                //$('#CategoryModal').modal('hide');
                                $('#ResponseImage').html('<img src="./error.jpg" style="height:130px;width:130px;" class="img-fluid" alt="">');
                                $('#ResponseText').text("Image format is not corerct");
                                $('#confirmModal').modal('show');
                            }
                        } else {
                            $('#ResponseImage').html('<img src="./error.jpg" style="height:130px;width:130px;" class="img-fluid" alt="">');
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#update_category_name') && $(el).val().match(/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/)) {
                    return 'Only allowed alphabets,numbers,- & _';
                    ...
                    success: function(data) {
                        ...
                        if (TestJson(data) == true) {
                            ...
                            if (response.UpdateCategory == "0") {
                                ...
                                $('#ResponseImage').html('<img src="./success.jpg" style="height:130px;width:130px;" class="img-fluid" alt="">');
                                $('#ResponseText').text("Successfully Updated Category");
                                $('#confirmModal').modal('show');
                    ...
                    success: function(data) {
                        ...
                        if (TestJson(data) == true) {
                            ...
                            if (delResponse.delCategory == 0) {
                                $('#ResponseImage').html('<img src="./warning.jpg" style="height:130px;width:130px;" class="img-fluid" alt="">');
                                $('#ResponseText').text("Category is Already in Use");
                                $('#confirmModal').modal('show');
                            } else if (delResponse.delCategory == 1) {
                                $('#ResponseImage').html('<img src="./success.jpg" style="height:130px;width:130px;" class="img-fluid" alt="">');
                                $('#ResponseText').text("Successfully Deleted Category");
                                $('#confirmModal').modal('show');
                                $('#updatecategory_form')[0].reset();
                                MasterTable.ajax.reload();
